...
$toEmail = "estivillm24@gmail.com"; // Replace Your Email Address
...
$fromEmail = "nintendo.estivill@gmail.com";  // Replace Company's Email Address (preferably currently used Domain Name)
$fromName = "Tails"; // Replace Company Name
...
/* --------------------------------------------
  // Subject
--------------------------------------------- */
$subject = "En respuesta a tu portfolio"; // Your Subject
...
if (filter_var($toEmail, FILTER_VALIDATE_EMAIL)) {
	...
	$success = "¡Gracias por contactar conmigo! En breve recibiras una respuesta"; // Success Message
